...
bool NhapNgaySinhNhatNguoiYeu VD:19/11(std::string fileName)
{
	...
	std::cout << "Nhap ngay sinh nhat cua nguoi ban yeu VD 19/11: ";
	...
	while(1)
	{
		...
		if (inputDob == correctDob)
			...
			std::cout << "Nhap sai ngay sinh nhat cua nguoi ban yeu roi DO NGU: ";
	}
